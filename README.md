Hi! I am **Minh-Thien Nguyen**, an AI Researcher specializing in **Natural Language Processing (NLP)** and **Deep Learning**.
...
Some of my best works include:
- ViCLIP-OT [[arXiv preprint](https://arxiv.org/abs/2602.22678)]: The First Foundation Vision-Language Model for Vietnamese Image–Text Retrieval with Optimal Transport.
- soups [[arXiv](https://arxiv.org/abs/2603.02181)]: Leveraging Model Soups to Classify Intangible Cultural Heritage Images from the Mekong Delta.
...
- [viettel-ai-race-vbkt](https://github.com/minhnguyent546/viettel-ai-race-vbkt): Multiple-Choice Question Answering (MCQA) Pipeline for Complex Technical Documents.
...
- X: [@minhnguyent546](https://x.com/minhnguyent546)
- Linkedin: [/in/minhnguyent546](https://www.linkedin.com/in/minhnguyent546)
